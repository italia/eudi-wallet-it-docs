...
**Steps 13-17**: The Wallet Provider's backend assesses the Wallet Attestation Request and issues a Wallet Attestation, if the requirements described below are satisfied:
    ...
    1. It MUST check the Wallet Attestation Request contains all the defined header according to :ref:`Table of the Wallet Attestation Request Header <table_wallet_attestation_request_claim>`.
