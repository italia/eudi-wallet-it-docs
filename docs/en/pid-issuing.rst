...
The requests at the Token Request endpoint of the PID Provider MUST be HTTP POST requests with the following mandatory parameters in the HTTP request message body using the ``application/x-www-form-urlencoded`` format.
